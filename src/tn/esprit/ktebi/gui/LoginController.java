            ...
            try {
                ...
                if (!se.VerifMail(txtemail.getText())) {
                    ...
                    try {
                        ...
                        User user = us.getUserByRole(u);
                        Role role = new Role();
                        System.err.println(user.getRole().getRole());
                        if (user.getRole().getRole().equals("Client")) {
                            ...
                            Parent root = FXMLLoader
                                    .load(getClass().getResource("../gui/Admin-ui.fxml"));
                            Scene scene = new Scene(root);
                            primaryStage.setTitle("Ktebi");
                            primaryStage.setScene(scene);
                            primaryStage.show();
                        } else if (user.getRole().getRole().equals("Auteur")) {
                            Parent root = FXMLLoader
                                    .load(getClass().getResource("../gui/homecartAut.fxml"));
                            Scene scene = new Scene(root);
                            primaryStage.setTitle("Ktebi");
                            primaryStage.setScene(scene);
                            primaryStage.show();
                            ...
                            Parent root = FXMLLoader
                                    .load(getClass().getResource("../gui/homeCartLib.fxml"));
                            Scene scene = new Scene(root);
                            primaryStage.setTitle("Ktebi");
                            primaryStage.setScene(scene);
                            primaryStage.show();
